...
<System.Serializable()> Public Class ClassDataset
    ...
    Public Function MergeDatatable(ByVal dt As DataTable, ByVal dt2 As DataTable) As DataTable
        dt.Merge(dt2, True, MissingSchemaAction.Add)
        Dim errRows() As DataRow = dt.GetErrors()
        Dim errRow As DataRow
        For Each errRow In errRows
            errRow.RejectChanges()
            errRow.RowError = Nothing
    ...
    Public Overloads Function dsQueryselect(ByVal queryString As String, ByVal connectionString As String) As DataSet
    ...
    Public Function UpLoadImageFile(ByVal info As String) As String
        ...
        Try
            ...
            base64 = Convert.ToBase64String(imgBin)
        Catch ex As Exception
        Finally
            stream.Close()
            stream.Dispose()
