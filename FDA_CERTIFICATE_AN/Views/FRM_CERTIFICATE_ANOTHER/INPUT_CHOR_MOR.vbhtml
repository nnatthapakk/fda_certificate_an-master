...
<div>
    <div class="ic" style="font-family:'Taviraj'">
        <div>
            <p style="text-align: right; font-size: 16px;">แบบ ช.ม.</p>
        </div>
        <div>
        ...
        <br />
        <center>
            <h4>คำขอหนังสือรับรองการนำหรือสั่งยาสำเร็จรูปสำหรับมนุษย์เข้ามาในราชอาณาจักร</h4>
        ...
        <table width="100%" style="font-size:20px">
            <tr>
                <td width="5%"></td>
                <td width="10%" style="text-align:right">๑. ข้าพเจ้า</td>
                <td width="70%" style="border-bottom:dotted;border-bottom-width:thin"></td>
                <td>ผู้ยื่นคำขอ</td>
            </tr>
        </table>
            ...
            <table class="table" style="font-size:20px" width="100%">
                <thead>
                    <tr>
                        ...
                        <th width="25%" style="text-align:center">ชื่อตำรับยา</th>
                        <th width="15%" style="text-align:center">เลขทะเบียน</th>
                        <th width="30%" style="text-align:center">ชื่อผู้ผลิต เมืองและประเทศผู้ผลิต</th>
