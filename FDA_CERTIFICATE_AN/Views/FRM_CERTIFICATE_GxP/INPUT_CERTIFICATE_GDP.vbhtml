@Code
    ViewData("Title") = "INPUT_CERTIFICATE_GDP"
End Code
...
<div>
    <div class="ic" style="font-family:'Taviraj'">
        ...
        <div class="border1">
            ...
            <br />
            <div style="font-size:20px;margin-left:5px"><b>เรื่อง</b><span style="padding-left:2em">ขอให้ออก GMP/GDP/FMP Certificate</span></div>
            <div style="font-size:20px;margin-left:5px"><b>เรียน</b><span style="padding-left:2em">หัวหน้ากลุ่มกำกับดูแลหลังออกสู่ตลาด</span></div>
