@Code
    ViewData("Title") = "FRM_MAIN_TRAN_CER"
    Layout = ""
End Code
...
<div ng-controller="CPP_CTRL" ng-app="ANGULAR_APP">
    <div class="ic" style="font-family:'Taviraj'">
        ...
        <div class="row">
            <table class="table">
                <tr>
                    <td width="70%"><h3>{{HEADER}}</h3></td>
                    <td align="center">
                        <input type="button" class="btn btn-lg" style="width:50%;background-color:#38A86B;color:white" ng-click="BTN_INPUT_TRAN(process)" value="สร้างคำขอ" />
                    </td>
                </tr>
            </table>
            <table class="table" style="width:90%;margin-left:5%">
                <tr>
                    <td width="20%"><b>เลขที่ใบอนุญาต :</b></td>
                    <td>
                        1A 1/62 (NG)
                    </td>
                </tr>
