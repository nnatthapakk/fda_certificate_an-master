<header>
    <section id="header">
        <div class="wrap-header">
            <div class="list-left">
                <div class="menu"></div><a class="logo-site" href="@Url.Action("Index", "Home")"><img src="../Images/layout/logo.svg"></a><span class="text-e" id="app">ระบบหนังสือรับรองด้านยา</span>
                                                                                                                                          <div id="result"></div>
            </div>
            <div class="list-sub-menu">
                <form class="search hide-xs"><input name="search" type="text"></form><div class="sub-menu search hide-xs"></div><div class="sub-menu noti">
                                ...
                                <div class="activity">
                                    <a class="list-act" href="https://www.google.co.th/" title="www.google.co.th" target="_blank">
                                        <div class="wrap-list-act">
                                            <img class="profile-small" src="../Images/layout/pp.png"><div class="wrap-text-act">
                                                <span class="t15 name">แมรี่</span> <span class="atslug"></span> <div class="action t13">ได้แสดงความคิดเห็นเกี่ยวกับคุณ</div>
                                            </div>
                                        </div>
                                    </a>
                                    <a class="list-act" href="https://www.google.co.th/" title="www.google.co.th" target="_blank">
                            ...
                            <div class="sub-extend-body">
                                ...
                                <div class="contain-nest-item-list i5">
                                    ...
                                    <div data-target="ii19" class="no-bot item-list section_2 clear-left">
                                        <img src="../Images/layout/icon/Asset 60.png">
                                        <div class="tt t13">จนท. อย.</div>
                                    </div>
                                    <div data-target="ii20" class="no-bot item-list section_2">
                                        <img src="../Images/layout/icon/Asset 70.png">
                                        <div class="tt t13">จนท. สสจ.</div>
                                    </div>
                                    <div class="no-bot item-list section_2">
                                        <img src="../Images/layout/icon/Asset 200.png">
