@Code
    ViewData("Title") = "FRM_MAIN_DRUG_CER"
    Layout = ""
End Code
        ...
        <div class="row">
            <table class="table">
                <tr>
                    ...
                    <td align="center">
                        <input type="button" class="btn btn-lg" style="width:50%;background-color:#71C970;color:white" ng-click="BTN_INPUT(process)" value="สร้างคำขอ" />
                    </td>
                </tr>
            </table>
