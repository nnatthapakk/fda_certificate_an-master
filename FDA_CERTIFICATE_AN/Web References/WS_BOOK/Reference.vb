...
Namespace WS_BOOK
    ...
    Partial Public Class Service1
        ...
        Private UPDATE_STATUS_BOOKING_DRUG_IDENTIFYOperationCompleted As System.Threading.SendOrPostCallback
        
        Private UPDATE_STATUS_BOOKING_HERBOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Private LOAD_DATA_BOOKING_DOCUMENTOperationCompleted As System.Threading.SendOrPostCallback
        ...
        Public Sub New()
            MyBase.New
            Me.Url = Global.FDA_CERTIFICATE_AN.My.MySettings.Default.FDA_CERTIFICATE_AN_WS_BOOK_Service1
        ...
        '''<remarks/>
        Public Event UPDATE_STATUS_BOOKING_DRUG_IDENTIFYCompleted As UPDATE_STATUS_BOOKING_DRUG_IDENTIFYCompletedEventHandler
        
        '''<remarks/>
        Public Event UPDATE_STATUS_BOOKING_HERBCompleted As UPDATE_STATUS_BOOKING_HERBCompletedEventHandler
        ...
        '''<remarks/>
        Public Event LOAD_DATA_BOOKING_DOCUMENTCompleted As LOAD_DATA_BOOKING_DOCUMENTCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/UPDATE_STATUS_BOOKING_DRUG_IDENTIFY", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function UPDATE_STATUS_BOOKING_DRUG_IDENTIFY(ByVal C_NUMBER As String, ByVal STAFF_IDENTIFY As String) As String
            Dim results() As Object = Me.Invoke("UPDATE_STATUS_BOOKING_DRUG_IDENTIFY", New Object() {C_NUMBER, STAFF_IDENTIFY})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub UPDATE_STATUS_BOOKING_DRUG_IDENTIFYAsync(ByVal C_NUMBER As String, ByVal STAFF_IDENTIFY As String)
            Me.UPDATE_STATUS_BOOKING_DRUG_IDENTIFYAsync(C_NUMBER, STAFF_IDENTIFY, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UPDATE_STATUS_BOOKING_DRUG_IDENTIFYAsync(ByVal C_NUMBER As String, ByVal STAFF_IDENTIFY As String, ByVal userState As Object)
            If (Me.UPDATE_STATUS_BOOKING_DRUG_IDENTIFYOperationCompleted Is Nothing) Then
                Me.UPDATE_STATUS_BOOKING_DRUG_IDENTIFYOperationCompleted = AddressOf Me.OnUPDATE_STATUS_BOOKING_DRUG_IDENTIFYOperationCompleted
            End If
            Me.InvokeAsync("UPDATE_STATUS_BOOKING_DRUG_IDENTIFY", New Object() {C_NUMBER, STAFF_IDENTIFY}, Me.UPDATE_STATUS_BOOKING_DRUG_IDENTIFYOperationCompleted, userState)
        End Sub
        
        Private Sub OnUPDATE_STATUS_BOOKING_DRUG_IDENTIFYOperationCompleted(ByVal arg As Object)
            If (Not (Me.UPDATE_STATUS_BOOKING_DRUG_IDENTIFYCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent UPDATE_STATUS_BOOKING_DRUG_IDENTIFYCompleted(Me, New UPDATE_STATUS_BOOKING_DRUG_IDENTIFYCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/UPDATE_STATUS_BOOKING_HERB", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function UPDATE_STATUS_BOOKING_HERB(ByVal C_NUMBER As String, ByVal STAFF_IDENTIFY As String) As String
            Dim results() As Object = Me.Invoke("UPDATE_STATUS_BOOKING_HERB", New Object() {C_NUMBER, STAFF_IDENTIFY})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub UPDATE_STATUS_BOOKING_HERBAsync(ByVal C_NUMBER As String, ByVal STAFF_IDENTIFY As String)
            Me.UPDATE_STATUS_BOOKING_HERBAsync(C_NUMBER, STAFF_IDENTIFY, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub UPDATE_STATUS_BOOKING_HERBAsync(ByVal C_NUMBER As String, ByVal STAFF_IDENTIFY As String, ByVal userState As Object)
            If (Me.UPDATE_STATUS_BOOKING_HERBOperationCompleted Is Nothing) Then
                Me.UPDATE_STATUS_BOOKING_HERBOperationCompleted = AddressOf Me.OnUPDATE_STATUS_BOOKING_HERBOperationCompleted
            End If
            Me.InvokeAsync("UPDATE_STATUS_BOOKING_HERB", New Object() {C_NUMBER, STAFF_IDENTIFY}, Me.UPDATE_STATUS_BOOKING_HERBOperationCompleted, userState)
        End Sub
        
        Private Sub OnUPDATE_STATUS_BOOKING_HERBOperationCompleted(ByVal arg As Object)
            If (Not (Me.UPDATE_STATUS_BOOKING_HERBCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent UPDATE_STATUS_BOOKING_HERBCompleted(Me, New UPDATE_STATUS_BOOKING_HERBCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://tempuri.org/LOAD_DATA_BOOKING_DOCUMENT", RequestNamespace:="http://tempuri.org/", ResponseNamespace:="http://tempuri.org/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function LOAD_DATA_BOOKING_DOCUMENT(ByVal REF_NO As String) As data_booking_document
            Dim results() As Object = Me.Invoke("LOAD_DATA_BOOKING_DOCUMENT", New Object() {REF_NO})
            Return CType(results(0),data_booking_document)
        End Function
        
        '''<remarks/>
        Public Overloads Sub LOAD_DATA_BOOKING_DOCUMENTAsync(ByVal REF_NO As String)
            Me.LOAD_DATA_BOOKING_DOCUMENTAsync(REF_NO, Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub LOAD_DATA_BOOKING_DOCUMENTAsync(ByVal REF_NO As String, ByVal userState As Object)
            If (Me.LOAD_DATA_BOOKING_DOCUMENTOperationCompleted Is Nothing) Then
                Me.LOAD_DATA_BOOKING_DOCUMENTOperationCompleted = AddressOf Me.OnLOAD_DATA_BOOKING_DOCUMENTOperationCompleted
            End If
            Me.InvokeAsync("LOAD_DATA_BOOKING_DOCUMENT", New Object() {REF_NO}, Me.LOAD_DATA_BOOKING_DOCUMENTOperationCompleted, userState)
        End Sub
        
        Private Sub OnLOAD_DATA_BOOKING_DOCUMENTOperationCompleted(ByVal arg As Object)
            If (Not (Me.LOAD_DATA_BOOKING_DOCUMENTCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent LOAD_DATA_BOOKING_DOCUMENTCompleted(Me, New LOAD_DATA_BOOKING_DOCUMENTCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Xml", "4.8.4084.0"),  _
     ...
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Xml.Serialization.XmlTypeAttribute([Namespace]:="http://tempuri.org/")>  _
    Partial Public Class DOCUMENT_CHECK
        
        Private iDAField As Integer
        
        Private fK_IDAField As String
        ...
        Private dOCUMENT_CHECK1Field As String
        ...
        Public Property FK_IDA() As String
            Get
                Return Me.fK_IDAField
            End Get
            Set
                Me.fK_IDAField = value
            End Set
        End Property
        ...
        '''<remarks/>
        <System.Xml.Serialization.XmlElementAttribute("DOCUMENT_CHECK")>  _
        Public Property DOCUMENT_CHECK1() As String
            Get
                Return Me.dOCUMENT_CHECK1Field
            End Get
            Set
                Me.dOCUMENT_CHECK1Field = value
            End Set
        End Property
    End Class
    ...
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Xml", "4.8.4084.0"),  _
     ...
     System.ComponentModel.DesignerCategoryAttribute("code"),  _
     System.Xml.Serialization.XmlTypeAttribute([Namespace]:="http://tempuri.org/")>  _
    Partial Public Class data_booking_document
        ...
        Private data_documentsField() As DOCUMENT_CHECK
        ...
        '''<remarks/>
        Public Property data_documents() As DOCUMENT_CHECK()
            Get
                Return Me.data_documentsField
            End Get
            Set
                Me.data_documentsField = value
            End Set
        End Property
    End Class
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")>  _
    Public Delegate Sub UPDATE_STATUS_BOOKING_DRUG_IDENTIFYCompletedEventHandler(ByVal sender As Object, ByVal e As UPDATE_STATUS_BOOKING_DRUG_IDENTIFYCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class UPDATE_STATUS_BOOKING_DRUG_IDENTIFYCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")>  _
    Public Delegate Sub UPDATE_STATUS_BOOKING_HERBCompletedEventHandler(ByVal sender As Object, ByVal e As UPDATE_STATUS_BOOKING_HERBCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class UPDATE_STATUS_BOOKING_HERBCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0")>  _
    Public Delegate Sub LOAD_DATA_BOOKING_DOCUMENTCompletedEventHandler(ByVal sender As Object, ByVal e As LOAD_DATA_BOOKING_DOCUMENTCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.8.4084.0"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class LOAD_DATA_BOOKING_DOCUMENTCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
        ...
        '''<remarks/>
        Public ReadOnly Property Result() As data_booking_document
            Get
                Me.RaiseExceptionIfNecessary
                Return CType(Me.results(0),data_booking_document)
            End Get
        End Property
    End Class
End Namespace
